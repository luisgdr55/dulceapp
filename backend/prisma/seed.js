...
async function main() {
  ...
  await prisma.tasaBCV.upsert({
    where: { id: 'seed-tasa' },
    update: { tasa: 46.5 },
    create: { id: 'seed-tasa', workspaceId: workspace.id, tasa: 46.5, esCurrent: true, fuente: 'manual' }
  })
  ...
  const ingredientesData = [
    ...
    { nombre: 'Cinta decorativa',     categoria: 'Empaques',     unidad: 'metro',  cantidadActual: 15,  cantidadMinima: 5,   precioEur: 0.30,  esAccesorio: true },
  ...
  const recetasData = [
    {
      ...
      costoIngredientesEur: 6.50, costoGasEur: 0.80, costoEmpaqueEur: 1.20, precioVentaEur: 18.00,
      variantes: [
    ...
    },
    {
      ...
      costoIngredientesEur: 2.20, costoGasEur: 0.40, costoEmpaqueEur: 0.60, precioVentaEur: 7.00,
      variantes: [
    ...
    },
    {
      ...
      costoIngredientesEur: 5.80, costoGasEur: 0.70, costoEmpaqueEur: 1.00, precioVentaEur: 20.00,
      variantes: [
    ...
    },
    {
      ...
      costoIngredientesEur: 3.50, costoGasEur: 0.50, costoEmpaqueEur: 1.80, precioVentaEur: 12.00,
      variantes: [
    ...
    },
    {
      ...
      costoIngredientesEur: 3.20, costoGasEur: 0.60, costoEmpaqueEur: 0.80, precioVentaEur: 12.00
    }
  ]
